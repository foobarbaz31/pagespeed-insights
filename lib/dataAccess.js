...
function getRawData (opts, callback) {
  ...
  if(opts.apiKey === undefined) {
    return callback(new Error('dataAccess.getRawData: api key is required to obtain pagespeed. ' +
      'Please visit https://console.developers.google.com/apis/library to obtain api key for ' + 
      'pagespeed insights'));
  }
